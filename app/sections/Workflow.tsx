      ...
      <div className="section-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-center mt-5 opacity-75">
            {language === "id" ? "Proses rekrutmen yang terstruktur dan efisien untuk kebutuhan bisnis Anda." : "A structured and efficient recruitment process for your business needs."}
          </p>
        </motion.div>
